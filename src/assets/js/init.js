	...
	var Core = {
		...
		headerNav: function() {
			...
			if ( $main_nav.exists() ) {
				...
				$shop_cart.appendTo($nav_list).wrap('<li className="main-nav__item--shopping-cart"></li>');

				// Add arrow and class if Top Bar menu ite has submenu
				$top_nav_li.has('ul').addClass('has-children').prepend('<span className="main-nav__toggle"></span>');
				...
				$logo_mobile.prepend('<span className="main-nav__back"></span>');
				...
				if ( $social.exists() ) {
					...
					social_li_new.appendTo($nav_list).wrapAll('<li className="main-nav__item--social-links"></li>');
				}
				...
				if ( $info_nav_li_onclick.exists() ){
					$info_nav_li_onclick.prepend('<span className="info-block__menu-icon"></span>');
				...
				$nav_list_li.has('.main-nav__sub').addClass('has-children').prepend('<span className="main-nav__toggle"></span>');
				$nav_list_li.has('.main-nav__megamenu').addClass('has-children').prepend('<span className="main-nav__toggle"></span>');
				...
				$('.main-nav__list > li > ul > li').has('.main-nav__sub-2').addClass('has-children').prepend('<span className="main-nav__toggle-2"></span>');
				$('.main-nav__list > li > ul > li > ul > li').has('.main-nav__sub-3').addClass('has-children').prepend('<span className="main-nav__toggle-2"></span>');
			...
			if (countdown.exists()){
				...
				countdown.countdown({
					...
					render: function(data) {
						$(this.el).html("<div className='countdown-counter__item countdown-counter__item--days'>" + this.leadingZeros(data.days, 2) + " <span className='countdown-counter__label'>days</span></div><div className='countdown-counter__item countdown-counter__item--hours'>" + this.leadingZeros(data.hours, 2) + " <span className='countdown-counter__label'>hours</span></div><div className='countdown-counter__item countdown-counter__item--mins'>" + this.leadingZeros(data.min, 2) + " <span className='countdown-counter__label'>mins</span></div><div className='countdown-counter__item countdown-counter__item--secs'>" + this.leadingZeros(data.sec, 2) + " <span className='countdown-counter__label'>secs</span></div>");
					}
				});
			}
			...
			if (countdownPlain.exists()){
				...
				countdownPlain.countdown({
					...
					render: function(date) {
						...
						$(this.el).html("<div className='alc-countdown-plain__item alc-countdown-plain__item--title'>Starts In:</div><div className='alc-countdown-plain__item alc-countdown-plain__item--days'>" + this.leadingZeros(date.days, 2) + " <span className='alc-countdown-plain__item-label'>days</span></div><div className='alc-countdown-plain__item alc-countdown-plain__item--hours'>" + this.leadingZeros(date.hours, 2) + " <span className='alc-countdown-plain__item-label'>hours</span></div><div className='alc-countdown-plain__item alc-countdown-plain__item--mins'>" + this.leadingZeros(date.min, 2) + " <span className='alc-countdown-plain__item-label'>mins</span></div><div className='alc-countdown-plain__item alc-countdown-plain__item--secs'>" + this.leadingZeros(date.sec, 2) + " <span className='alc-countdown-plain__item-label'>secs</span></div><div className='alc-countdown-plain__progress progress-grid-wrapper'><div className='progress progress--lines progress--lines-sm'><div className='progress__bar progress__bar--gradient-primary-success' style='width: " + progressBarValue + "%;' role='progressbar' aria-valuenow='" + progressBarValue + "' aria-valuemin='0' aria-valuemax='100'></div></div></div>");
					}
				});
			}
		},
		...
		miscScripts: function() {
			...
			// Duotone effect
			$('.effect-duotone').prepend('<div className="effect-duotone__layer"><div className="effect-duotone__layer-inner"></div></div>');
