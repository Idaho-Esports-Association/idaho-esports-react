...
(n="transform: translateY(-"+this.shiftArrows+"px);",q="transform: translateY("+this.shiftArrows+"px);"));a+='" />';this.btn1=m('<i className="'+c+l+p+'" style="'+n+e+": "+d+'px">');this.btn2=m('<i className="'+b+l+f+'" style="'+q+g+": "+d+'px">');this.btn=m(a).on("mousedown touchstart",this.onMouseDown.bind(this));this.btn[0].appendChild(this.btn1[0]);this.btn[0].appendChild(this.btn2[0]);d=parseInt(h.width,10);a=[];d&&(h='<span className="rs-addon-beforeafter-line rs-before-after-element rs-beforeafter-'+this.direction+
