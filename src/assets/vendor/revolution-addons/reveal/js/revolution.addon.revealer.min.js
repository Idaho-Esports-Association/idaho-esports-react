;/*
 ...
 @version   1.0.0
*/
(function(){window.RsRevealerAddOn=function(p,a,F){function y(){if(!q){switch(r){case "open_horizontal":c+="width: 50%; height: 100%; top: 0; left: 0";t+="width: 50%; height: 100%; top: 0; left: 50%";b.width="0%";u.left="100%";break;case "open_vertical":c+="width: 100%; height: 50%; top: 0; left: 0";t+="width: 100%; height: 50%; top: 50%; left: 0";b.height="0%";u.top="100%";break;case "split_left_corner":c+='<polygon className="rs_addon_point1" points="0,0 500,0 500,500" style="fill:'+h+"; stroke:"+h+
'; stroke-width: 1" /><polygon className="rs_addon_point2" points="0,0 0,500 500,500" style="fill:'+h+"; stroke:"+h+'; stroke-width: 1" />';isCorner=!0;v=G;b.x=500;u.x=-500;break;case "split_right_corner":c+='<polygon className="rs_addon_point1" points="0,0 500,0 0,500" style="fill:'+h+"; stroke:"+h+'; stroke-width: 1" /><polygon className="rs_addon_point2" points="500,0 500,500 0,500" style="fill:'+h+"; stroke:"+h+'; stroke-width: 1" />';isCorner=!0;v=G;b.x=-500;u.x=500;break;case "shrink_circle":var e=2*Math.max(a.width(),
...
("off"!==g.spinner?window.requestAnimationFrame(P):(g.spinner="on",Q()));if("none"===r)a.one("revolution.slide.onloaded",function(){f&&f.length&&(g.loader=f)});else{a.addClass("rs_addon_reveal").find("li").first().attr("fstransition","notransition").data("fstransition","notransition");var n=p('<div className="rs_addon_revealer" />'),z=-1!==r.search("open"),I=-1!==r.search("corner");m=d.easing.split(".");var A="fullwidth"===g.sliderLayout&&-1!==r.search("skew"),b={ease:punchgs[m[0]][m[1]],onComplete:L},
